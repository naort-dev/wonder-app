      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Text style={{ color: theme.colors.textColor }}>
            Terms and Conditions Agreement between User and www.getwonderapp.com
            Welcome to www.getwonderapp.com. The www.getwonderapp.com website
            (the "Site") is comprised of various web pages operated by Wonder.
            www.getwonderapp.com is offered to you conditioned on your
            acceptance without modification of the terms, conditions, and
            notices contained herein (the "Terms"). Your use of
            www.getwonderapp.com constitutes your agreement to all such Terms.
            Please read these terms carefully, and keep a copy of them for your
            reference. www.getwonderapp.com is a Dating Site. Landing page for
            the Wonder Dating App, an app that matches users based on activities
            and looks. Privacy Your use of www.getwonderapp.com is subject to
            Wonder's Privacy Policy. Please review our Privacy Policy, which
            also governs the Site and informs users of our data collection
            practices. Electronic Communications Visiting www.getwonderapp.com
            or sending emails to Wonder constitutes electronic communications.
            ...
            Children Under Thirteen Wonder does not knowingly collect, either
            online or offline, personal information from persons under the age
            of thirteen. If you are under 18, you may use www.getwonderapp.com
            only with permission of a parent or guardian. Links to Third Party
            Sites/Third Party Services www.getwonderapp.com may contain links to
            other websites ("Linked Sites"). The Linked Sites are not under the
            control of Wonder and Wonder is not responsible for the contents of
            any Linked Site, including without limitation any link contained in
            a Linked Site, or any changes or updates to a Linked Site. Wonder is
            providing these links to you only as a convenience, and the
            inclusion of any link does not imply endorsement by Wonder of the
            site or any association with its operators. Certain services made
            available via www.getwonderapp.com are delivered by third party
            sites and organizations. By using any product, service or
            functionality originating from the www.getwonderapp.com domain, you
            hereby acknowledge and consent that Wonder may share such
            information and data with any third party with whom Wonder has a
            contractual relationship to provide the requested product, service
            or functionality on behalf of www.getwonderapp.com users and
            customers. No Unlawful or Prohibited Use/Intellectual Property You
            are granted a non-exclusive, non-transferable, revocable license to
            access and use www.getwonderapp.com strictly in accordance with
            these terms of use. As a condition of your use of the Site, you
            warrant to Wonder that you will not use the Site for any purpose
            ...
            the property of Wonder or its suppliers and protected by copyright
            ...
            of the content, in whole or in part, found on the Site. Wonder
            ...
            content without the express written permission of Wonder and the
            ...
            express or implied, to the intellectual property of Wonder or our
            licensors except as expressly authorized by these Terms.
            International Users The Service is controlled, operated and
            administered by Wonder from our offices within the USA. If you
            ...
            will not use the Wonder Content accessed through
            www.getwonderapp.com in any country or in any manner prohibited by
            any applicable laws, restrictions or regulations. Indemnification
            You agree to indemnify, defend and hold harmless Wonder, its
            ...
            laws, rules or regulations. Wonder reserves the right, at its own
            ...
            fully cooperate with Wonder in asserting any available defenses.
            ...
            concerns these Terms and Conditions, the prevailing party shall be
            entitled to recover its costs and reasonable attorney's fees. The
            ...
            and Conditions. Class Action Waiver Any arbitration under these
            ...
            Wonder agree otherwise, the arbitrator may not consolidate more than
            ...
            WONDER AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN
            THE SITE AT ANY TIME. WONDER AND/OR ITS SUPPLIERS MAKE NO
            ...
            PROVIDED "AS IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. WONDER
            ...
            IN NO EVENT SHALL WONDER AND/OR ITS SUPPLIERS BE LIABLE FOR ANY
            ...
            EVEN IF WONDER OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE
            ...
            USING THE SITE. Termination/Access Restriction Wonder reserves the
            ...
            and Wonder as a result of this agreement or use of the Site.
            Wonder's performance of this agreement is subject to existing laws
            and legal process, and nothing contained in this agreement is in
            derogation of Wonder's right to comply with governmental, court and
            law enforcement requests or requirements relating to your use of the
            Site or information provided to or gathered by Wonder with respect
            ...
            agreement between the user and Wonder with respect to the Site and
            ...
            Wonder with respect to the Site. A printed version of this agreement
            ...
            Changes to Terms Wonder reserves the right, in its sole discretion,
            to change the Terms under which www.getwonderapp.com is offered. The
            most current version of the Terms will supersede all previous
            versions. Wonder encourages you to periodically review the Terms to
            stay informed of our updates. Contact Us Wonder welcomes your
            questions or comments regarding the Terms: Wonder 4500 Woodman
            Avenue C301 Sherman Oaks, California 91423 Email Address:
            admin@getwonderapp.com Telephone number: 213-249-2062 Effective as
            of July 20, 2018{" "}
          </Text>
